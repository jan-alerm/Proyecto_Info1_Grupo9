...
class AirportApp:
    def __init__(self, root):
        ...
        # BOTONES
        tk.Button(self.root, text="Show Flight Trajectories", width=30, command=self.f_map_flights).pack(pady=2)

        tk.Button(self.root, text="Show Long Distance Flights", width=30, command=self.f_long_flights).pack(pady=2)
